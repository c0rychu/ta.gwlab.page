...
The total electric flux $\Phi_E$ through any \emph{closed} surface $S$, known as a Gaussian surface, equals the total charge enclosed by $S$ divided by $\epsilon_0$:
\begin{keyeq}
    \label{eq:gauss-law}
    \Phi_E
    =
...
The law holds for a closed surface of any shape and size.

\begin{figure}[htbp]
    \centering
    \tikzfig{ch01-gauss-surface-sphere.tex}
    \caption{A spherical Gaussian surface $S'$ of radius $R$ centred on the
